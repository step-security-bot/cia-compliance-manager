...
[CIA Compliance Manager — Markdown Documentation](../../modules.md) / constants/uiConstants
...
- [getComponentIcon](functions/getComponentIcon.md)
- [getBusinessImpactIcon](functions/getBusinessImpactIcon.md)
