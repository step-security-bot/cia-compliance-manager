...
[CIA Compliance Manager — Markdown Documentation](../../../modules.md) / [constants/designTokens](../README.md) / WIDGET\_DESIGN

# Variable: WIDGET\_DESIGN

> `const` **WIDGET\_DESIGN**: `object`

Defined in: [constants/designTokens.ts:207](https://github.com/Hack23/cia-compliance-manager/blob/b616fbaa2bb30d924b7315cd583f8328bb70f347/src/constants/designTokens.ts#L207)
...
> `readonly` **shadow**: `"0 2px 8px 0 rgba(0, 0, 0, 0.1)"` = `'0 2px 8px 0 rgba(0, 0, 0, 0.1)'`
...
> `readonly` **headerHeight**: `"48px"` = `'48px'`
