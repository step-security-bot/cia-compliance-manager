...
[CIA Compliance Manager — Markdown Documentation](../../../modules.md) / [constants/keyboardShortcuts](../README.md) / KEYBOARD\_SHORTCUTS

# Variable: KEYBOARD\_SHORTCUTS

> `const` **KEYBOARD\_SHORTCUTS**: `object`

Defined in: [constants/keyboardShortcuts.ts:15](https://github.com/Hack23/cia-compliance-manager/blob/b616fbaa2bb30d924b7315cd583f8328bb70f347/src/constants/keyboardShortcuts.ts#L15)
...
> `readonly` **category**: [`ShortcutCategory`](../../../types/keyboard/type-aliases/ShortcutCategory.md)
