...
[CIA Compliance Manager — Markdown Documentation](../../modules.md) / types/widget-props
...
- [CIAComponentWidgetProps](interfaces/CIAComponentWidgetProps.md)
- [SecurityLevelChangeWidgetProps](interfaces/SecurityLevelChangeWidgetProps.md)
- [AllCIAComponentsProps](interfaces/AllCIAComponentsProps.md)
- [WidgetPropsWithLoading](interfaces/WidgetPropsWithLoading.md)
...
- [ImpactWidgetProps](interfaces/ImpactWidgetProps.md)
...
- [CIALevelsOnly](type-aliases/CIALevelsOnly.md)
- [PartialCIALevels](type-aliases/PartialCIALevels.md)
- [SecuritySummaryWidgetProps](type-aliases/SecuritySummaryWidgetProps.md)
...
- [SecurityVisualizationWidgetProps](type-aliases/SecurityVisualizationWidgetProps.md)
