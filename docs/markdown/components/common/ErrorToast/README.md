...
[CIA Compliance Manager — Markdown Documentation](../../../modules.md) / components/common/ErrorToast

# components/common/ErrorToast
...
- [ErrorToastProps](interfaces/ErrorToastProps.md)
...
- [ErrorToast](variables/ErrorToast.md)

## References

### default

Renames and re-exports [ErrorToast](variables/ErrorToast.md)
