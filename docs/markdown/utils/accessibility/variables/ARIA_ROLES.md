...
[CIA Compliance Manager — Markdown Documentation](../../../modules.md) / [utils/accessibility](../README.md) / ARIA\_ROLES

# Variable: ARIA\_ROLES

> `const` **ARIA\_ROLES**: `object`

Defined in: [utils/accessibility.ts:15](https://github.com/Hack23/cia-compliance-manager/blob/136c4eac67174302169f1de284a10b51af1f24f5/src/utils/accessibility.ts#L15)
...
> `readonly` **CONTENTINFO**: `"contentinfo"` = `'contentinfo'`
...
> `readonly` **TABLIST**: `"tablist"` = `'tablist'`
...
> `readonly` **TABPANEL**: `"tabpanel"` = `'tabpanel'`
...
> `readonly` **LISTITEM**: `"listitem"` = `'listitem'`
