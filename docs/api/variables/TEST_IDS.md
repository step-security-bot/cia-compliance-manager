...
[CIA Compliance Manager API Documentation](../globals.md) / TEST\_IDS

# Variable: TEST\_IDS

> `const` **TEST\_IDS**: `object`

Defined in: [src/constants/testIds.ts:409](https://github.com/Hack23/cia-compliance-manager/blob/main/src/constants/testIds.ts#L409)
