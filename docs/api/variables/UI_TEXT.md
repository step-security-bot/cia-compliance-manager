...
[CIA Compliance Manager API Documentation](../globals.md) / UI\_TEXT

# Variable: UI\_TEXT

> `const` **UI\_TEXT**: `object`

Defined in: [src/constants/coreConstants.ts:105](https://github.com/Hack23/cia-compliance-manager/blob/main/src/constants/coreConstants.ts#L105)
