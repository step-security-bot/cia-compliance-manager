...
[CIA Compliance Manager — UML Diagrams](../../modules.md) / [utils](../README.md) / sanitizeWidgetId

# Variable: sanitizeWidgetId

> **sanitizeWidgetId**: (`id`) => `string`

Defined in: [utils/index.ts:137](https://github.com/Hack23/cia-compliance-manager/blob/326f5e224f54a8645f7aa8019136892910008a47/src/utils/index.ts#L137)
