...
[CIA Compliance Manager Diagrams](../../modules.md) / [utils](../README.md) / WidgetClasses

# Variable: WidgetClasses

> `const` **WidgetClasses**: `object`

Defined in: [utils/tailwindClassHelpers.ts:34](https://github.com/Hack23/cia-compliance-manager/blob/5d9bfa9bf972c007ee203f3866fd9fbbb105b179/src/utils/tailwindClassHelpers.ts#L34)
