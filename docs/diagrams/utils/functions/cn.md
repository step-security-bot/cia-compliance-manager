...
[CIA Compliance Manager Diagrams](../../modules.md) / [utils](../README.md) / cn

# Function: cn()

> **cn**(...`classes`): `string`

Defined in: [utils/tailwindClassHelpers.ts:294](https://github.com/Hack23/cia-compliance-manager/blob/5d9bfa9bf972c007ee203f3866fd9fbbb105b179/src/utils/tailwindClassHelpers.ts#L294)
