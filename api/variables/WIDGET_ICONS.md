...
[CIA Compliance Manager API Documentation](../globals.md) / WIDGET\_ICONS

# Variable: WIDGET\_ICONS

> `const` **WIDGET\_ICONS**: `object`

Defined in: [src/constants/uiConstants.ts:6](https://github.com/Hack23/cia-compliance-manager/blob/main/src/constants/uiConstants.ts#L6)
